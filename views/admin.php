            ...
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 text-center justify-content-center px-xl-6 aos-init aos-animate" data-aos="fade-up">
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            ...
                            <h6 class="font-weight-bold mb-3">Manage Student List</h6>
                ...
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            <div class="text-primary mb-5">
                                <img src="https://img.icons8.com/office/80/000000/department.png" />
                            </div>
                ...
                <div class="col my-3">
                    <div class="card border-hover-primary hover-scale">
                        <div class="card-body">
                            <div class="text-primary mb-5">
                            <img src="https://img.icons8.com/external-others-phat-plus/64/000000/external-courses-online-courses-color-line-others-phat-plus-10.png" height="79"/>
                            </div>
                            <h6 class="font-weight-bold mb-3">Add new courses</h6>
